...
{
    public class CuboidMeshComponent : EntityComponent
    {
        ...
        public CuboidMeshComponent(int entityID, GraphicsDevice graphics, float sizeX, float sizeY, float sizeZ, BasicEffect effect) : base(entityID)
        {
